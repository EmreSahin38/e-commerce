...
CREATE TABLE IF NOT EXISTS `denememodul` (
  ...
  `seflink` varchar(255) COLLATE utf8mb4_turkish_ci DEFAULT NULL,
  `kategori` int DEFAULT NULL,
  `metin` mediumtext COLLATE utf8mb4_turkish_ci DEFAULT NULL,
  `resim` varchar(255) COLLATE utf8mb4_turkish_ci DEFAULT NULL,
  `anahtar` varchar(255) COLLATE utf8mb4_turkish_ci DEFAULT NULL,
  `description` varchar(255) COLLATE utf8mb4_turkish_ci DEFAULT NULL,
  `durum` int DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `iadeler` (
  ...
  `metin` mediumtext COLLATE utf8mb4_turkish_ci DEFAULT NULL,
  `cevap` mediumtext COLLATE utf8mb4_turkish_ci DEFAULT NULL,
  `durum` int DEFAULT NULL,
  `tarih` date DEFAULT NULL,
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_turkish_ci;
...
(1, 4, '1', '1', 10, '2025-05-16'),
(2, 4, '1', '2', 10, '2025-05-16'),
(3, 4, '1', '3', 10, '2025-05-16'),
(4, 4, '1', '4', 10, '2025-05-16'),
(5, 4, '2@3', '5@7', 12, '2025-05-16'),
(6, 4, '2@3', '5@8', 11, '2025-05-16'),
(7, 4, '2@3', '5@9', 8, '2025-05-16'),
(8, 4, '2@3', '6@7', 13, '2025-05-16'),
(9, 4, '2@3', '6@8', 10, '2025-05-16'),
(10, 4, '2@3', '6@9', 9, '2025-05-16');
